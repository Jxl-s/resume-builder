const messages = {
    ...
    ToolBar: {
        ...
        ai_ask: "Demander IA",
        hyperlink_desc:
            "Sélectionnez du texte, entrez un lien, cliquez sur Ajouter.",
        add: "Ajouter",
        import: "Importer",
    ...
    Right: {
        ...
        take_snapshot: "Prendre un snapshot",
        create_snapshot: "Créer un nouveau snapshot",
        enter_snapshot_name: "Entrez le nom du snapshot",
        save_snapshot: "Sauvegarder le snapshot",
        load: "Charger",
        delete: "Supprimer",
        update: "Mettre à jour",
        delete_snapshot: "Supprimer le snapshot",
